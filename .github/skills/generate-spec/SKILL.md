...
- [ ] Alineada con arquitectura REST y automatización Karate
...
2. Explora código existente — no duplicar aserciones ni flujos de API existentes
...
- `## 2. DISEÑO` — endpoints API (request/response/HTTP codes)
- `## 3. LISTA DE TAREAS` — checklists de QA/Karate `[ ]`
